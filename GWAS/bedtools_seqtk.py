...
def main():
    while True:
        ...
        if answer == 'y' or answer == 'Y':
            ...
            bedtools(seq_postition, reseq='/mnt/storage/zhaoziquan/GWAS/1_bwaindex/xso-gene.fa', myseq='myseq', bedtools_path='/mnt/storage/zhaoziquan/GWAS/software/bedtools2/bin/bedtools')
        else:
...
def bedtools(seq_postition, reseq = '/mnt/storage/zhaoziquan/GWAS/1_bwaindex/xso-gene.fa', myseq = 'myseq', bedtools_path = '/mnt/storage/zhaoziquan/GWAS/software/bedtools2/bin/bedtools'):
